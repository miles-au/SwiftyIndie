    ...
    return (
        <div className="legal-page legal-page--privacy container">
            ...
            <section className="legal-page__content">
                ...
                <p>We may rely on third-party service providers to help operate our apps, such as analytics, subscription management, crash reporting, hosting, payment processing, and app distribution platforms. Those providers may process limited technical or transaction-related data on our behalf in accordance with their own terms and privacy policies. For example, TelemetryDeck&apos;s privacy policy is available at <a href="https://telemetrydeck.com/privacy">https://telemetrydeck.com/privacy</a>, and RevenueCat&apos;s privacy information is available at <a href="https://www.revenuecat.com/privacy">https://www.revenuecat.com/privacy</a>.</p>
                ...
                <p className="legal-page__effective-date">Effective date: March 24, 2026. Updated for RevenueCat disclosures.</p>
            </section>
